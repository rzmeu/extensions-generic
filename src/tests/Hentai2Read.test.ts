...
import {Hentai2Read} from '../Hentai2Read/Hentai2Read'

describe('Hentai2Read Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new Hentai2Read(cheerio)
     ...
     */
    const mangaId = 'fgo_humiliation' // Water Overflow
