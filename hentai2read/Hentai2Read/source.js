...
},{"./Hentai2ReadParser":60,"buffer":3,"paperback-extensions-common":16}],60:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Hentai2ReadParser {
    constructor(cheerio, domain) {
        this.parsePagedResult = (data, page) => {
            const mangaTiles = [];
    ...
    parseChapterUploadDate(uploadedDateText) {
...
},{"entities":11,"paperback-extensions-common":16}]},{},[59])(59)
});
